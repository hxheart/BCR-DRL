...
for index_run in range(0,num_run_index):
    caci_return_softmax_env_all.append(np.load(f'./data/cr_bcr/cr_data_bcr_weights_env_{index_run}.npy'))
...
for index_run in range(0,num_run_index):
    caci_return_softmax_ent_all.append(np.load(f'./data/cr_bcr/cr_data_bcr_weights_AI_{index_run}.npy'))
...
for index_run in range(0,num_run_index):
    caci_return_softmax_cau_all.append(np.load(f'./data/cr_bcr/cr_data_bcr_weights_human_{index_run}.npy'))
...
for index_run in range(0,num_run_index):
    ppobc_return_shaped_all.append(np.load(f'./data/cr_ppobc/cr_data_ppobc_return_stage_{index_run}.npy'))
    ppobc_return_sparse_all.append(np.load(f'./data/cr_ppobc/cr_data_ppobc_return_sparse_{index_run}.npy'))
    # ppobc_return_env_all.append(np.load(f'./data/cr_ppobc/cr_data_fading_ppobc_return_env_{index_run}.npy'))
...
for index_run in range(0,num_run_index):
    caci_return_shaped_all.append(np.load(f'./data/cr_bcr/cr_data_bcr_return_stage_{index_run}.npy'))
    caci_return_sparse_all.append(np.load(f'./data/cr_bcr/cr_data_bcr_return_sparse_{index_run}.npy'))
    caci_return_cau_all.append(np.load(f'./data/cr_bcr/cr_data_bcr_return_human_{index_run}.npy'))
    caci_return_ent_all.append(np.load(f'./data/cr_bcr/cr_data_bcr_return_AI_{index_run}.npy'))
...
plt.xlim([0, xlim_max])
plt.ylim([0, ylim_max])
plt.savefig('./figs/cr_fading_return_caci.pdf', format='pdf')
...
for index_run in range(0,num_run_index):
    causal_return_shaped_all.append(np.load(f'./data/cr_causal/cr_data_causal_return_stage_{index_run}.npy'))
    causal_return_sparse_all.append(np.load(f'./data/cr_causal/cr_data_causal_return_sparse_{index_run}.npy'))
    causal_return_cau_all.append(np.load(f'./data/cr_causal/cr_data_causal_return_causal_{index_run}.npy'))
...
# for index_run in range(0,num_run_index):
#     causal_return_cau_all.append(np.load(f'./data/cr_causal/cr_data_fading_causal_return_cau_{index_run}.npy'))
#     caci_return_cau_all.append(np.load(f'./data/cr_bcr/cr_data_fading_caci_return_cau_{index_run}.npy'))
...
# for index_run in range(0,num_run_index):
#     ppobc_return_shaped_all.append(np.load(f'./data/cr_ppobc/cr_data_ppobc_return_stage_{index_run}.npy'))
#     causal_return_shaped_all.append(np.load(f'./data/cr_causal/cr_data_fading_causal_return_stage_{index_run}.npy'))
#     caci_return_shaped_all.append(np.load(f'./data/cr_bcr/cr_data_fading_caci_return_shaped_{index_run}.npy'))
...
# for index_run in range(0,num_run_index):
#     ppobc_return_env_all.append(np.load(f'./data/cr_ppobc/cr_data_fading_ppobc_return_env_{index_run}.npy'))
#     causal_return_env_all.append(np.load(f'./data/cr_causal/cr_data_fading_causal_return_env_{index_run}.npy'))
#     caci_return_env_all.append(np.load(f'./data/cr_bcr/cr_data_fading_caci_return_env_{index_run}.npy'))
...
# 读取数据
cr_ppobc_return_sparse_mean = np.mean(np.load(f'./data/test/cr_ppobc/cr_test_data_ppobc_return_sparse.npy'))
cr_causal_return_sparse_mean = np.mean(np.load(f'./data/test/cr_causal/cr_test_data_causal_return_sparse.npy'))
cr_bcr_return_sparse_mean = np.mean(np.load(f'./data/test/cr_bcr/cr_test_data_bcr_return_sparse.npy'))
...
ppobc_return_sparse_all = load_data('./data/cr_ppobc/cr_data_ppobc_return_sparse_{}.npy', num_runs_begin, num_runs_end)
caci_no_weights_return_sparse_all = load_data('./data/cr_bcr_no_weights/cr_data_bcr_no_weights_return_sparse_{}.npy', num_runs_begin, num_runs_end)
caci_return_sparse_all = load_data('./data/cr_bcr/cr_data_bcr_return_sparse_{}.npy', num_runs_begin, num_runs_end)
