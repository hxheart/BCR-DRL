...
if __name__ == "__main__":
    for layout in [
        ...
        bc_dir = os.path.join(current_file_dir, "bc_runs_ccima", "reproduce_train", layout) # 使用os.path.join将当前文件目录路径current_file_dir与子目录"bc_runs/train/layout"拼接在一起，生成一个新的路径。其中layout个变量，是上面5个中的一个
