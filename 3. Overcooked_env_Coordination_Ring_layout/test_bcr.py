...
if bc_model_path_train == "./bc_runs_ccima/reproduce_train/coordination_ring":
    ...
    # --
    actor.load_weights("./data/model/model_co_actor_ppobc_5.h5")
    critic.load_weights("./data/model/model_co_critic_ppobc_5.h5")
    epochs = int(400)
    # --
...
# plt.savefig('./figs/caci_avg_return_env.pdf', format='pdf')  
